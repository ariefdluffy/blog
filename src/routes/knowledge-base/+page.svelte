<script>
    ...
    import { ArrowRight, Layers, ExternalLink } from "lucide-svelte";
...
<SEO
    ...
    description="Kumpulan tips, referensi, dan catatan pengetahuan"
/>
...
<section class="mb-10">
    ...
    >
        ...
        >
            Kumpulan tips, referensi, dan catatan pengetahuan. Dikurasi dari
            pengalaman dan sumber terpercaya.
        </p>
    </div>
</section>
...
<section>
                    ...
                    <div class="p-5">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="min-w-0 flex-1">
                                <h3
                                    class="text-sm font-bold group-hover:text-primary transition-colors mb-1.5"
                                >
                                    {cat.title}
                                </h3>
                                {#if cat.description}
                                ...
                                {/if}
                                <div
                                    class="flex items-center gap-1 text-[10px] text-primary mt-3 opacity-0 group-hover:opacity-100 transition-opacity"
                                >
                                    <ArrowRight size={10} /> Lihat materi
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    {#if data.totalCount > 5}
        <div class="text-center mt-4">
            ...
            >
                Lihat {data.totalCount - 5} lainnya
            </a>
        </div>
    {/if}
</section>
...
>
    <p class="text-xs text-text-muted dark:text-dark-text-muted italic">
        Knowledge base diperbarui secara berkala
    </p>
</section>
